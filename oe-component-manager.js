...
import "./src/oe-component-editor.js";
import "./src/oe-component-preview.js";
import "./src/oe-component-footer.js";

/**
 * `oe-component-manager`
 *  Polymer 3 component for editing UIComponents
 ...
 */
class OeComponentManager extends OECommonMixin(PolymerElement) {
  static get is() {
    return 'oe-component-manager';
  }
  ...
  static get template() {
    ...
    <div class="app-body layout horizontal">
      <oe-component-preview id="preview" class$="[[_previewClass]]" component="[[workingComponent]]" template-containers="{{containerList}}" meta-data="{{metaData}}"></oe-component-preview>
...
window.customElements.define(OeComponentManager.is, OeComponentManager);